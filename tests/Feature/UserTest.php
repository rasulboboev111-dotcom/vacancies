...
class UserTest extends TestCase
{
    ...
    public function test_branch_user_sees_only_own_branch_employees(): void
    {
        $pos = Position::create(['name' => 'Manager']);
        Employee::create([
            'branch_id' => $this->branch2->id,
        ...
        $response->assertStatus(200);
        $response->assertSee('Own Branch Employee');
        $response->assertDontSee('Other Branch Employee');
    }
